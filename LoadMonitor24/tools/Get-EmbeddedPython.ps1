...
# python.org 공식 임베더블 배포판(약 11MB)을 받아 LoadMonitor24\python\ 에 풀어둔다.
...
# LoadMonitor24 폴더를 통째로(python\ 포함) 복사하면 된다.
...
Write-Host ''
Write-Host '[embed-py] 완료 - 이제 LoadMonitor24-UI.bat 더블클릭으로 바로 실행됩니다.'
