...
NEED = [
    "LoadMonitor25-UI.bat",
    "LoadMonitor25.bat",
    "LoadMonitor25-팀취합.bat",
    "LoadMonitor25-팀서버.bat",
    "LoadMonitor25-팀업로드.bat",
    "LoadMonitor25-수집진단.bat",
    "LoadMonitor25-샘플러등록.bat",
    "LoadMonitor25-이동준비.bat",
    "LoadMonitor25-빠른이동.bat",
    "agentic.py",
    "freeze.py",
    "team_report.py",
    "flow.py",
...
if miss:
    ...
    for m in miss:
        print("    " + m)
    sys.exit(1)
print("[OK] 전부 있습니다. LoadMonitor25-UI.bat 을 실행하세요.")
