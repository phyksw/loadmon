# -*- coding: utf-8 -*-
r"""
freeze.py — 분석 결과를 '파일 하나' 보고서 3종으로 만든다 (LoadMonitor25).
...
def _freeze(tag, full, base_url, log, info):
    ...
    baked["_lm"] = {"kind": "frozen", "owner": owner, "host": host,
                    ...
                    "generated": time.strftime("%Y-%m-%d %H:%M"), "generator": "LoadMonitor25 freeze.py"}
...
def report_island(tag, full=True, log=_say):
    ...
    island = json.dumps({
        ...
        "generated": generated, "generator": "LoadMonitor25 freeze.py",
