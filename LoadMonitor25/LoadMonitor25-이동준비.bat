...
rem 폴더 경로는 끝 역슬래시를 뗀 정규 경로로 넘긴다. 예전의 -Root "%%~dp0." 는 "...\LoadMonitor25\." 로 들어가
...
cd /d "%TEMP%"
start "LoadMonitor25 - PC 이동 준비" powershell -NoProfile -ExecutionPolicy Bypass -File "%TEMP%\LM22-Prepare-Move.ps1" -Root "%LM_ROOT%"
exit
